                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    ...
                    <div className="flex items-start gap-3 p-3 bg-amber-500/10 border border-amber-500/30 rounded-xl">
                        ...
                        <p className="text-xs text-amber-200/80">
                            Reminders will be sent to Telegram bot. Make sure <code className="bg-slate-800 px-1 rounded">NEXT_PUBLIC_TELEGRAM_BOT_TOKEN</code> and <code className="bg-slate-800 px-1 rounded">NEXT_PUBLIC_TELEGRAM_CHAT_ID</code> are configured in .env
                        </p>
                    </div>
